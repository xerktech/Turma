...
- Both events STAGE on the reader thread and DELIVER on the beat (a callback may not socket-write to
  another session). Mechanics + pitfalls: `.claude/rules/dsh-input.md`.
