...
See `.claude/rules/turma-notifications.md` — edge-triggered FCM alerts, the one-alert-per-piece-of-
work rule, runaway session spend (XERK-310), Claude login alerts, `notify()`/`push.js`, dismiss
retraction, `pushEnabled`.
