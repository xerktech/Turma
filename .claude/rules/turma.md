...
See `.claude/rules/turma-memory.md` — the in-flight body budget, the derived ceilings and the hold
factor they come from, the history-cache byte bound, and the refusal rules (413 vs 503, terminal vs
advertised).
