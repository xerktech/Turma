...
| `.claude/rules/board-ticket-view.md` | `turma/server.js`, `board.js` + its vendored copies, `core/Board.kt` | routing a ticket to a host that can run it, and the hub resolving a ticket as the board does |
